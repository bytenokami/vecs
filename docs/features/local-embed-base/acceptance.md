...
- [x] Phase-4 adversarial review run on the diff (3 lenses, 14 findings, fix-then-ship); 13 fixed in-branch, remainder logged in `gaps.md` (backfill precondition → L3 runbook; lazy-client ordering accepted)
