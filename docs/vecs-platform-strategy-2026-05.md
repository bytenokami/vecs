...
2. **`voyage-3.5` upgrade + reranker behind a flag** (Pillar 1) — biggest quality jump for the effort; verify dim compatibility first. **[v5: reranker is now full `rerank-2.5`, default-ON, E-gated — not flag-off; see Inc 7 in the curation design.]**
